  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-8">
      ...
      <div className="absolute top-8 left-8">
        <button
          onClick={() => router.back()}
          className="flex items-center gap-2 text-gray-600 hover:text-black transition-colors font-display"
        >
      ...
      <div className="max-w-2xl w-full">
        ...
        {/* Heading */}
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-6 font-display tracking-tight">
        ...
        <div className="space-y-6 mb-8">
          <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
            <p className="text-lg text-gray-800 leading-relaxed font-display">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-black text-white flex items-center justify-center text-sm font-bold mt-0.5">
                1
              </div>
              <div>
                <p className="text-base text-gray-700 leading-relaxed font-display">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          />
          <label htmlFor="acknowledge-checkbox" className="text-base text-gray-700 cursor-pointer select-none font-display">
        ...
        >
          <div className="flex items-center justify-center overflow-clip px-6 py-4 relative rounded-[100px] shadow-[0px_0px_2px_0px_rgba(0,0,0,0.1),0px_1px_8px_0px_rgba(0,0,0,0.1)] bg-white transition-transform group-hover:scale-105">
            ...
            <span className="text-lg font-semibold text-black font-display tracking-tight mr-2">
              Continue
            </span>
