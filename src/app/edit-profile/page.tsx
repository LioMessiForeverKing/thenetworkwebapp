...
export default function EditProfile() {
  ...
  if (loading) {
    return <div className={styles.page} style={{ justifyContent: 'center', alignItems: 'center' }}>Loading...</div>;
  }
    ...
    <>
      ...
      <div className={styles.page}>
        ...
        <div className={styles.avatarBlock} onClick={handleAvatarClick} style={{ cursor: 'pointer' }}>
          <div className={styles.avatar} style={avatarUrl ? { backgroundImage: `url(${avatarUrl})` } : {}}></div>
