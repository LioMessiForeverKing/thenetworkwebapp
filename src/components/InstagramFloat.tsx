...
export default function InstagramFloat({ variant = 'floating' }: InstagramFloatProps) {
  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className={`w-6 h-6 md:w-7 md:h-7 ${isFloating ? 'brightness-0 invert' : 'brightness-0 invert'}`}
      >
