...
export default function InstagramFloat() {
  ...
  return (
    <button
      onClick={handleClick}
      className={`fixed z-50 flex items-center justify-center transition-all duration-700 ease-in-out hover:scale-110 active:scale-95 
        bottom-12 left-4 w-6 h-6 mix-blend-difference
        md:bottom-24 md:left-6 md:w-14 md:h-14 md:rounded-full md:shadow-lg md:mix-blend-normal
        ${
        isDark
          ? 'md:bg-black md:hover:bg-gray-800'
    ...
    >
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className="w-6 h-6 md:w-7 md:h-7 text-white md:text-current"
      >
